...
function generateShape(data) {
  ...
  ${circle.render()}
      <text x="100" y="135" font-size="30" text-anchor="middle" fill="${
        circle.textColor
      }">${circle.text}</text>
      </svg>
      `;
    ...
    return `<?xml version="1.0" standalone="no"?>
      <svg width="200" height="250" version="1.1" xmlns="http://www.w3.org/2000/svg">
  ${square.render()}
        <text x="150" y="175" font-size="15" text-anchor="middle" fill="${
          square.textColor
        }">${square.text}</text>
      </svg>
      `;
  ...
  <svg width="200" height="250" version="1.1" xmlns="http://www.w3.org/2000/svg">
  ${triangle.render()}
    <text x="100" y="175" font-size="15" text-anchor="middle"fill="${
      triangle.textColor
    }">${triangle.text}</text>
  </svg>
      `;
